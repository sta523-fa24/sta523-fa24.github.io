...
As you have likely noticed, the individual characters in a string (element of a character vector) cannot be directly accessed. The base R provides a number helper functions for pattern matching and manipulation of these strings:
...
![](imgs/hex-stringr.png){width=10% fig-align="center" }
...
cat(1/10^(0:5), sep="\n")
formatC(
  1/10^(0:5), digits = 6, width = 6, format = "fg"
) |> 
  cat(sep="\n")
```
:::
