...
* [`sqldf`](https://github.com/ggrothendieck/sqldf) - transparently creates a database with data and then runs the query using that database. Defaults to SQLite but other backends are available.
